    ...
    return (
        <section className="py-24 px-4 container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[400px]">
                ...
                <BentoCard className="bg-charcoal dark:bg-[#1E1E22]! p-8 flex flex-col justify-between" delay={0.2}>
                    <Activity className="w-12 h-12 text-primary" />
                    <div>
                        <div className="text-6xl font-condensed font-bold text-white">12k+</div>
                        <p className="text-gray-400 mt-2">Daily loops created</p>
                    </div>
                </BentoCard>
                ...
                <BentoCard className="md:col-span-2 lg:col-span-2 relative overflow-hidden flex items-center bg-[#D93F3F] text-white" delay={0.4}>
                    ...
                    <div className="relative z-10 p-12 flex flex-col md:flex-row gap-8 items-center w-full">
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-white text-xl font-medium drop-shadow-lg max-w-lg">Connect with thousands of active people in your city.</p>
                        </div>
