        ...
        <section className="py-24 bg-primary text-white">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="bg-charcoal text-white border-2 border-charcoal px-8 py-4 rounded-xl font-medium flex items-center justify-center gap-3 hover:bg-gray-900 transition-colors shadow-lg">
                        {/* Apple Icon */}
                    ...
                    <button className="bg-transparent text-white border-2 border-white px-8 py-4 rounded-xl font-medium flex items-center justify-center gap-3 hover:bg-white hover:text-primary transition-colors">
                        {/* Google Play Icon */}
